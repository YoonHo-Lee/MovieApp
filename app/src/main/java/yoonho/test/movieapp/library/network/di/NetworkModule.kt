package yoonho.test.movieapp.library.network.di
...
import yoonho.test.movieapp.library.network.retrofit.NetworkRequestFactoryImpl
import yoonho.test.movieapp.library.network.retrofit.StringConverterFactory
import javax.inject.Singleton

@Module
@InstallIn(SingletonComponent::class)
// @InstallIn : 어디서 접근이 가능한지 설정.
// SingletonComponent : 모든 곳에서 접근이 가능하다고 설정.
class NetworkModule {
